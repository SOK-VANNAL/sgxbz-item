...
export class ItemEditComponent implements OnInit{
  ...
  initControl(item: ItemEdit): void{
    const {nameMaxLengthValidator, noteMaxLengthValidator, codeMaxLengthValidator, required, pattern, nameExistValidator, codeExistValidator, barcodeExistValidator} = MyValidators;
